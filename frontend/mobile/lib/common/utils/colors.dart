...
const fourth = Color(0xFF232323);
const textFieldColor = Color(0xffEDEFF3);
const blueColor = Color.fromRGBO(44, 100, 229, 1);
const redColor = Color(0xFFFF4848);
const buttonBackgroundColor = Color.fromARGB(255, 209, 228, 255);
