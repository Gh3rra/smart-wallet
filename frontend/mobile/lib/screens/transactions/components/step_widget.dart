...
class _StepWidgetState extends State<StepWidget> {
  ...
  setCategoryList() async {
    ...
    if (type == Type.entrata) {
      List<CategoryModel> categories = await Db().getIncomeCategories();
      ...
      List<CategoryModel> categories = await Db().getExpenseCategories();
      for (var element in categories) {
        categoryList.add(DropdownMenuItem(
          value: element,
          child: Text(element.name),
  ...
  setWalletList() async {
    ...
    List<WalletModel> wallets = await Db().getWallets();
              ...
              children: [
                Padding(
                  ...
                  child: MyTextField(
                    ...
                    textCapitalization:
                        Provider.of<ThemeManager>(context).capsLock == true
