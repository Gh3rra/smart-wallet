...
import 'package:mobile/screens/settings/category/components/add_expense_category_widget%20copy.dart';
import 'package:mobile/screens/settings/category/components/add_income_category_widget.dart';
import 'package:mobile/common/widgets/category_widget.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: MyButton(
                  onPressed: () async {
                    await showDialog(
                      context: context,
                      builder: (context) => const AddExpenseCategoryWidget(),
                    );
                  },
              ...
              StreamBuilder(
                  stream: Db().getExpenseCategoriesStream(),
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData && snapshot.data!.isNotEmpty) {
                      final categoryList = snapshot.data!.map(
                        (e) {
