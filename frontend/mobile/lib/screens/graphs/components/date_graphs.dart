...
class DateGraphs extends StatefulWidget {
  /// Pagina dei grafici
  const DateGraphs({super.key, required this.transactions});
  final List<TransactionModel> transactions;

  @override
  State<DateGraphs> createState() => _DateGraphsState();
}

class _DateGraphsState extends State<DateGraphs> {
