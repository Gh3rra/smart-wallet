...
import 'package:mobile/common/widgets/add_wallet_widget.dart';
import 'package:mobile/common/widgets/wallet_card.dart';
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          height: 150,
          child: StreamBuilder(
              stream: Db().getWalletsStream(),
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  List<WalletModel> wallets = snapshot.data!
                      .map(
                        (e) => WalletModel.fromMap(e),
                      )
                      .toList();
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return WalletCard(
                          wallet: wallet,
                          firstCard: index == 0,
                          lastCard: index == wallets.length - 1,
                        );
                      });
                }
                return const Center(
