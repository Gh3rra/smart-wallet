...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  /* Future<void> generateVerificationCode() async {
    ...
    final smptServer =
        gmail("smartwallet.app.help@gmail.com", "jvkw ecrt wteu pqlr");
    final emailToSend = Message()
      ..from = const Address("smartwallet.app.help@gmail.com")
      ..recipients.add(Address(widget.email))
      ..subject = "RESET"
      ..text = "Ciao $verificationCode";

    try {
      await send(emailToSend, smptServer);
    } catch (e) {
      print(e);
    }
  } */
